...
sensor_mappings = {
    ...
    "Bedroom Nightstand": {
        ...
        3: {
            "Bedroom Floor Tim": half_plain_white_light_state,
            "Bedroom Floor Alicia": half_plain_white_light_state,
            "Bedroom Table Tim": off_light_state,
            "Bedroom Table Alicia": off_light_state,
            "Bedroom Overhead 1": off_light_state,
            "Bedroom Overhead 2": off_light_state,
    ...
    "Alicia Office": {
        ...
        3: {
            "Alicia Office Table": half_plain_white_light_state,
            "Alicia Office Overhead": half_plain_white_light_state,
            "Alicia Office Floor 1": half_plain_white_light_state,
            "Alicia Office Floor 2": half_plain_white_light_state,
        },
        4: {
            "Hallway West 1": plain_white_light_state,
            "Hallway West 2": plain_white_light_state,
